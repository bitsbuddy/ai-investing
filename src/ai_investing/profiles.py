...
_PROFILE_PRESETS: dict[str, StrategyParameters] = {
    "conservative": StrategyParameters(
        ...
        equity_count=4,
        defensive_count=2,
        min_risk_on_positions=4,
        trend_window=200,
        rebalance_frequency="monthly",
        cash_buffer=0.10,
        target_equity_allocation=0.25,
        max_position_weight=0.23,
        max_equity_position_weight=0.10,
        max_sector_weight=0.20,
        max_benchmark_weight=0.45,
